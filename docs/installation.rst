...
``tendril-iotedge`` can be installed normally from the Python Package Index.
...
`github releases <https://github.com/tendril-framework/tendril-iotedge/releases>`_.
...
``tendril-iotedge``. ``sudo`` may be necessary if you are not installing
into a virtual environment.

.. code-block:: console

    $ git clone https://github.com/tendril-framework/tendril-iotedge.git
    $ cd tendril-iotedge
    $ pip install -e .
