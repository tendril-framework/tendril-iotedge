...
setup(
    ...
    keywords='tendril',
    url='https://github.com/tendril-framework/tendril-iotedge',
    project_urls={
        'Documentation': 'https://tendril-iotedge.readthedocs.io/en/latest',
        'Bug Tracker': 'https://github.com/tendril-framework/tendril-iotedge/issues',
        'Source Repository': 'https://github.com/tendril-framework/tendril-iotedge',
    },
